					...
					<form:form id="form1" method="post"
						...
						<div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
							...
							<div class="w-full">
								...
								<form:input type="date" path="date_of_employment"
							...
							<div class="w-full">
								<label for="phone_number"
									...
									Number</label>
								<form:input path="phone_number" name="phone_number"
							...
							<div class="w-full">
								<label for="salary"
									class="block mb-2 text-sm font-medium text-teal-900 dark:text-white">Salary</label>
								<form:input path="salary" name="salary" placeholder="salary"
									class="bg-teal-50 border border-teal-300 text-teal-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-teal-700 dark:border-teal-600 dark:placeholder-teal-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
									required="" />
							</div>
							<div class="w-full">
								<label for="Qualification"
									class="block mb-2 text-sm font-medium text-teal-900 dark:text-white">Qualifications</label>
